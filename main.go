...
func main() {
	...
	c.OnHTML("h1", func(a *colly.HTMLElement) {
		data.Title = a.Text
		//head := PageContent{Title: a.Title}
	})
	//get text <p>
	c.OnHTML("p", func(h *colly.HTMLElement) {
		//p := PageContent{Text: h.Text}
		data.Text += h.Text + "\n"

	})
	//after crawling, print URL, convert tojsonline file
	...
	//err = c.Visit("https://en.wikipedia.org/wiki/Robotics")
